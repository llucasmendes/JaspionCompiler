...
//----------------------------------------------------------------------------
typedef enum {INT, string, VOID} tipoespecificador;
typedef enum {IGUAL, DIF, MEI, MAI, ME, MA} relacional;                       //<<<<-------- PRIMEIRA MODIFICAÇÃO
typedef enum {SOMA, SUBT} soma;
typedef enum {MULT, DIVI} mult;
//----------------------------------------------------------------------------
//programa : declaracaolista
